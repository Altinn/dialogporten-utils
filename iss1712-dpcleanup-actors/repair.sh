#!/usr/bin/env bash
#
# iss1712-dpcleanup-actors: drive maintenance.iss1712dpcleanupactors_run_batch in a loop until the
...
export PGAPPNAME="maint-iss1712-dpcleanup-actors-${WORKER_ID}"
...
cat >&2 <<BANNER
$(ts) iss1712-dpcleanup-actors worker starting
...
while :; do
    ...
    result=$(psql "${PSQL_ARGS[@]}" -c "
        ...
        CALL maintenance.iss1712dpcleanupactors_run_batch(
